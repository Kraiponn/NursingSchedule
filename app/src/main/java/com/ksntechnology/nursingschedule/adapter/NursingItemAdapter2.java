...
public class NursingItemAdapter2 extends RecyclerView.Adapter {
    private Context mContext;
    private List mItem;
    private NursingListManager dao;
    ...
    public void setDao(NursingListManager dao) {
        this.dao = dao;
    }
    ...
    public NursingItemAdapter2(Context mContext, List mDao) {
    ...
    public int getItemCount() {
        ...
        if(dao.getDao() == null)
            return 0;
        else if(dao.getDao().getData() == null)
            return 0;
        else if(dao.getDao().getData().size() <= 0)
            return 0;

        return dao.getDao().getData().size();
    }
